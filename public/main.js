...
module.exports = "<div *ngIf=\"this.subscribeVisibility\" class=\"requestModal text-center\">\n  <form>\n      <!-- Industry, Region, Position and ServiceType will be a select inputs-->\n      <table class=\"text-left\">\n          <tr>\n              <th colspan=\"2\"><p>Please provide your contact info.<br/>\n                                We'll keep you up-to-date on the latest<br/> \n                                in technology in industry</p></th>\n          </tr>\n          <tr>\n              <td><label>First Name</label></td><td><input placeholder=\"New\" [(ngModel)]=\"subscriberInfo.firstName\" [ngModelOptions]=\"{standalone:\n                  true}\" type=\"text\" required/></td>\n          </tr>\n          <tr>\n              <td><label>Last Name</label></td><td><input placeholder=\"Subscriber\" [(ngModel)]=\"subscriberInfo.lastName\" [ngModelOptions]=\"{standalone:\n                  true}\" type=\"text\" required/></td>\n          </tr>\n          <tr>\n              <td><label>Email</label></td><td><input placeholder=\"yourname@example.com\" [(ngModel)]=\"subscriberInfo.email\" [ngModelOptions]=\"{standalone:\n                  true}\" type=\"text\" required/></td>\n          </tr>\n          <tr>\n              <td><label>Cell #</label></td><td><input placeholder=\"xxxxxxxxxx\" [(ngModel)]=\"subscriberInfo.phone\" [ngModelOptions]=\"{standalone:\n                  true}\" type=\"text\" required/></td>\n          </tr>\n          <tr>\n              <td><label>Company</label></td><td><input placeholder=\"Inc500\" [(ngModel)]=\"subscriberInfo.company\" [ngModelOptions]=\"{standalone:\n                  true}\" type=\"text\" required/></td>\n          </tr>\n          <tr>\n              <td><label>Industry</label></td><td><input placeholder=\"IOT\" [(ngModel)]=\"subscriberInfo.industry\" [ngModelOptions]=\"{standalone:\n                  true}\" type=\"text\" required/></td>\n          </tr>\n          <tr>\n              <td><label>Dept. Function</label></td><td><input placeholder=\"Operations Management\" [(ngModel)]=\"subscriberInfo.department\" [ngModelOptions]=\"{standalone:\n                  true}\" type=\"text\" required/></td>\n          </tr>\n          <tr>\n              <td><label>Position</label></td><td><input placeholder=\"CTO\" [(ngModel)]=\"subscriberInfo.position\" [ngModelOptions]=\"{standalone:\n                  true}\" type=\"text\" required/></td>\n          </tr>\n      </table>\n      <p>\n            <button class=\"btn-success\" (click)=\"confirmSubscription()\">Submit</button>&nbsp;&nbsp;<button class=\"btn-danger\" (click)=\"subscribe()\">Cancel</button>\n      </p>\n  </form>\n</div>\n<div *ngIf=\"this.confirmVisibility\" class=\"confirmModal text-center\">\n  <form>\n      <p>Please confirm submission<br/>\n      <table>\n          <tr>\n              <th colspan=\"2\"></th>\n          </tr>\n          <tr>\n              <td>First Name</td><td>{{subscriberInfo.firstName}}</td>\n          </tr>\n          <tr>\n              <td>Last Name</td><td>{{subscriberInfo.lastName}}</td>\n          </tr>\n          <tr>\n              <td>Email</td><td>{{subscriberInfo.email}}</td>\n          </tr>\n          <tr>\n              <td>Office #</td><td>{{subscriberInfo.phone}}</td>\n          </tr>\n          <tr>\n              <td>Company</td><td>{{subscriberInfo.company}}</td>\n          </tr>\n          <tr>\n              <td>Industry</td><td>{{subscriberInfo.industry}}</td>\n          </tr>\n          <tr>\n              <td>Dept. Function</td><td>{{subscriberInfo.department}}</td>\n          </tr>\n          <tr>\n              <td>Position</td><td>{{subscriberInfo.position}}</td>\n          </tr>\n      </table>\n      <p>\n            <button class=\"btn-success\" (click)=\"submitSubscription()\">Confirm</button>&nbsp;&nbsp;<button class=\"btn-danger\" (click)=\"confirmSubscription()\">Cancel</button>\n      </p>\n  </form>\n</div>\n\n"
...
module.exports = "<h1>{{serviceLine}}</h1>\n<div class=\"listBox\">\n        <span *ngFor=\"let service of list | myfilter:serviceLine\" class=\"textLeft\">\n                <button type=\"button\" class=\"btn btn-primary btn-lg btn-block\"(click)=\"ShowService(service); UpdateVisibility(); ShowDetail();\" routerLink=\"/services/\">{{service.name}}</button>\n        </span>\n</div>"
